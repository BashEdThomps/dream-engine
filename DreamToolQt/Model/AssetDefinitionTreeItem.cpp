...
(const QList<QVariant> &data, Dream::AssetDefinition* definition, AssetDefinitionTreeItem *parent)
    : GenericTreeItem(data, GenericTreeItemType::ASSET_DEFINITION, parent)
{
