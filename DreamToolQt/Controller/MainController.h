...
public slots:
    ...
    void onAssetDefinitionProperty_ScriptTemplateChanged(IAssetDefinition*,  QString&);
    void onAssetDefinitionProperty_ShaderTemplateChanged(IAssetDefinition*,  QString&);
