...
void testNode() {
	...
	dsNodeInitWithName(child1,"Child1");
	...
	dsNodeInitWithName(child2,"Child2");
	...
	dsNodeInitWithName(child1_1,"Child1_1");
	...
	dsNodeInitWithName(child1_1_1,"Child1_1_1");
	...
	unitAssertNotZero("Root parent of Child1",dsNodeIsParentOf(root,child1));
	unitAssertNotZero("Root parent of Child2",dsNodeIsParentOf(root,child2));
	unitAssertNotZero("Child1 parent of Child1_1",dsNodeIsParentOf(child1,child1_1));
	unitAssertNotZero("Child1_1 parent of Child1_1_1",dsNodeIsParentOf(child1_1,child1_1_1));

	unitAssertNotZero("Child1 child of Root",dsNodeIsChildOf(root,child1));
	unitAssertNotZero("Child2 child of Root",dsNodeIsChildOf(root,child2));
	unitAssertNotZero("Child1_1 child of Child1",dsNodeIsChildOf(child1,child1_1));
	unitAssertNotZero("Child1_1_1 child of Child1_1",dsNodeIsChildOf(child1_1,child1_1_1));
