...
namespace Dream {
    ...
    bool JoystickManager::IsInitialised = false;

    vector<SDL_GameController*> JoystickManager::ControllerHandles = vector<SDL_GameController*>();
    vector<SDL_Joystick*> JoystickManager::JoystickHandles = vector<SDL_Joystick*>();
