...
namespace Dream {
  ...
  void Project::loadScenesFromJson(nlohmann::json jsonSceneArray) {
    ...
    for (nlohmann::json::iterator it = jsonSceneArray.begin(); it != jsonSceneArray.end(); ++it) {
      ...
      Dream::Scene *nextScene = new Dream::Scene((*it));
  ...
  Dream::Scene* Project::getStartupScene() {
  ...
  void Project::addScene(Dream::Scene *scene) {
  ...
  Dream::Scene* Project::getSceneByUUID(std::string uuid) {
    Dream::Scene* retval = NULL;
    for(std::vector<Dream::Scene*>::iterator it = mScenes.begin(); it != mScenes.end(); ++it) {
  ...
  Dream::Scene* Project::getSceneByName(std::string name) {
    Dream::Scene* retval = NULL;
    for(std::vector<Dream::Scene*>::iterator it = mScenes.begin(); it != mScenes.end(); ++it) {
