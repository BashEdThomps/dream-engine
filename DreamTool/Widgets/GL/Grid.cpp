...
namespace octronic::dream::tool
{
  ...
  (DreamToolContext& p)
    : GLWidget(p),
      mAxisPair(AxisPair::XZ),
      mSize(100.f),
      mMajorSpacing(10.0f),
      mMinorSpacing(1.0f),
      mMajorColour(vec4(1.0f, 1.0f, 1.0f, 1.0f)),
      mMinorColour(vec4(0.6f,0.6f,0.6f,1.f))

  {
    LOG_DEBUG("Grid: Constructing with majorSpacing: {}, minorSpacing {}", mMajorSpacing, mMinorSpacing);
  }
