...
namespace octronic::dream
{
  ...
  public:
    ...
    optional<reference_wrapper<TemplateEntityDefinition>> getTemplateEntityDefinition() const;
  ...
  protected:
    ...
    optional<reference_wrapper<TemplateEntityDefinition>> mTemplateEntityDefinition;
