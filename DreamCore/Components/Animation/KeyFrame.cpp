...
namespace Dream
{
    ...
    void
    KeyFrame::generateNoneInterpolationFrames
    ...
    float
    KeyFrame::getBezierPoint
    (float n1, float n2, float perc)
    {
        float diff = n2 - n1;
        return n1 + ( diff * perc );
    }
    ...
    void
    KeyFrame::generateBezierInterpolationFrames
    (KeyFrame* toKeyFrame, long numFrames)
    {
        int x1 = 0, y1 = 0, z1 = 0;
        int x2 = 0, y2 = 0, z2 = 0;
