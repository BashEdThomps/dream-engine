...
namespace Dream
{
    ...
    {
    public:
        NanoVGComponent(ProjectRuntime* pr, WindowComponent* windowComponent);
        ...
        float Text(float x, float y, const char* string);
        ...
        void TextBox(float x, float y, float breakRowWidth, std::string str);
