...
namespace Dream
{
    ...
    void
    NanoVGComponent::BeginFrame
    (float windowWidth, float windowHeight, float devicePixelRatio)
    {
        nvgBeginFrame(mContext,windowWidth,windowHeight,devicePixelRatio);
    }

    void
    NanoVGComponent::CancelFrame
    ()
    {
    ...
    void
    NanoVGComponent::GlobalCompositeOperation
    (int op)
    {
    ...
    void
    NanoVGComponent::GlobalCompositeBlendFunc
    ...
    void
    NanoVGComponent::GlobalCompositeBlendFuncSeparate
    ...
    NVGcolor
    NanoVGComponent::LerpRGBA
    (NVGcolor c0, NVGcolor c1, float u)
    {
        return nvgLerpRGBA(c0,c1,u);
    }

    NVGcolor
    NanoVGComponent::TransRGBA
    (NVGcolor c0, unsigned char a)
    {
        return nvgTransRGBA(c0,a);
    }

    NVGcolor
    NanoVGComponent::TransRGBAf
    (NVGcolor c0, float a)
    {
    ...
    NVGcolor
    NanoVGComponent::HSLA
    (float h, float s, float l, unsigned char a)
    {
        return nvgHSLA(h,s,l,a);
    }

    void
    NanoVGComponent::Save
    ()
    {
        nvgSave(mContext);
    }
    ...
    void
    NanoVGComponent::ShapeAntiAlias
    (int enabled)
    {
    ...
    void
    NanoVGComponent::ResetTransform
    ()
    {
    ...
    void
    NanoVGComponent::CurrentTransform
    (float* xform)
    {
    ...
    void
    NanoVGComponent::TransformIdentity
    (float* dst)
    {
    ...
    void
    NanoVGComponent::TransformTranslate
    (float* dst, float tx, float ty)
    {
        nvgTransformTranslate(dst,tx,ty);
    }

    void
    NanoVGComponent::TransformScale
    (float* dst, float sx, float sy)
    {
        nvgTransformScale(dst,sx,sy);
    }

    void
    NanoVGComponent::TransformRotate
    (float* dst, float a)
    {
    ...
    void
    NanoVGComponent::TransformSkewX
    (float* dst, float a)
    {
    ...
    void
    NanoVGComponent::TransformSkewY
    (float* dst, float a)
    {
    ...
    void
    NanoVGComponent::TransformMultiply
    ...
    void
    NanoVGComponent::TransformPremultiply
    (float* dst, const float* src)
    {
    ...
    int
    NanoVGComponent::TransformInverse
    (float* dst, const float* src)
    {
    ...
    void
    NanoVGComponent::TransformPoint
    ...
    int
    NanoVGComponent::CreateImage
    (const char* filename, int imageFlags)
    {
        return nvgCreateImage(mContext,filename,imageFlags);
    }

    int
    NanoVGComponent::CreateImageMem
    (int imageFlags, unsigned char* data, int ndata)
    {
        return nvgCreateImageMem(mContext,imageFlags,data,ndata);
    }

    int
    NanoVGComponent::CreateImageRGBA
    ...
    void
    NanoVGComponent::UpdateImage
    (int image, const unsigned char* data)
    {
        nvgUpdateImage(mContext,image,data);
    }

    void
    NanoVGComponent::ImageSize
    ...
    NVGpaint
    NanoVGComponent::LinearGradient
    ...
    NVGpaint
    NanoVGComponent::RadialGradient
    ...
    NVGpaint
    NanoVGComponent::ImagePattern
    (float ox, float oy, float ex, float ey, float angle, int image, float alpha)
    {
        return nvgImagePattern(mContext,ox,oy,ex,ey,angle,image,alpha);
    }

    void
    NanoVGComponent::Scissor
    ...
    void
    NanoVGComponent::IntersectScissor
    (float x, float y, float w, float h)
    {
    ...
    void
    NanoVGComponent::Arc
    (float cx, float cy, float r, float a0, float a1, int dir)
    {
        nvgArc(mContext,cx,cy,r,a0,a1,dir);
    }

    void
    NanoVGComponent::Rect
    (float x, float y, float w, float h)
    {
    ...
    void
    NanoVGComponent::RoundedRectVarying
    ...
    int
    NanoVGComponent::AddFallbackFontId
    (int baseFont, int fallbackFont)
    {
        return nvgAddFallbackFontId(mContext,baseFont,fallbackFont);
    }

    int
    NanoVGComponent::AddFallbackFont
    (const char* baseFont, const char* fallbackFont)
    {
        return nvgAddFallbackFont(mContext,baseFont,fallbackFont);
    }

    void
    NanoVGComponent::FontSize
    (float size)
    {
    ...
    void
    NanoVGComponent::TextLetterSpacing
    (float spacing)
    {
    ...
    void
    NanoVGComponent::TextLineHeight
    (float lineHeight)
    {
    ...
    (float x, float y, float breakRowWidth, const char* string, const char* end)
    {
    ...
    (float x, float y, float breakRowWidth, const char* string, const char* end, float* bounds)
    {
    ...
    {
        float b[4];
        nvgTextBoxBounds(mContext,x,y,breakRowWidth,str.c_str(),nullptr,&b[0]);
